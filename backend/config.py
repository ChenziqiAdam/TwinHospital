...
class ExportConfig(BaseModel):
    ...
    file_name_pattern: str = Field(
        default="hospital_simulation_{timestamp}.json", 
...
class MonitoringConfig(BaseModel):
    ...
    duration_seconds: int = Field(default=360, description="Duration to monitor export file changes")
...
class Config(BaseModel):
    ...
    def load_from_yaml(cls, config_path: str) -> 'Config':
        ...
        export_config = ExportConfig(**yaml_data.get('continuous_export', {}))
